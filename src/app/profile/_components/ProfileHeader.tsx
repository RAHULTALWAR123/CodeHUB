    ...
    >
      ...
      <div className="relative flex items-center gap-8">
        <div className="relative group">
          ...
          {userData.isPro && (
            <div
              className="absolute -top-2 -right-2 bg-gradient-to-r from-green-500 to-emerald-600 p-2
        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            {userData.isPro && (
              <span className="px-3 py-1 bg-green-500/10 text-emerald-400 rounded-full text-sm font-medium">
                Pro Member
              </span>
            )}
          </div>
